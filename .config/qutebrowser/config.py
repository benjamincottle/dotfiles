...
## Type: QtColor
c.colors.completion.match.fg = nord['nord8']
...
## Type: QssColor
c.colors.completion.scrollbar.fg = nord['nord1']
...
## Type: QtColor
c.colors.hints.match.fg = nord['nord3']
...
## Type: QssColor
c.colors.messages.info.bg = nord['nord3']
...
## Type: QssColor
c.colors.statusbar.url.hover.fg = nord['nord6']
...
## (https).
## Type: QssColor
c.colors.statusbar.url.success.https.fg = nord['nord5']
...
## Type: QtColor
c.colors.tabs.selected.odd.bg = nord['nord2']
...
## Type: String
c.content.headers.accept_language = 'da-DK,da;q=0.9,en-US,en;q=0.8'
...
c.statusbar.widgets = ['keypress', 'url', 'text:  ', 'history', 'text:  ', 'scroll', 'tabs', 'progress']
...
config.bind('C', 'hint links spawn --detach catt cast {hint-url}')
...
config.bind('sd', 'spawn --userscript password_fill')
# config.bind('sf', 'save')
